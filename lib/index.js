...
const getWaterLevelURL = (country, prefecture, river) => {
  return `/production/water-level/countries/${ country }/prefectures/${ prefecture }/rivers/${ river }`;
};

const getRainFallURL = () => {
...
module.exports = {
  ...
  requestWaterLevel: (country, prefecture, river, param) => {
    httpRequest(`https://${ constants.host }${ getWaterLevelURL(country, prefecture, river) }`, 'GET')
      .then((res) => {
        try {
